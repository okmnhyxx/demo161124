...
public class OkHttpUtils {
    ...
    OkHttpClient client = new OkHttpClient.Builder().readTimeout(1, TimeUnit.HOURS).build();
    Gson gson = new Gson();
    String charset = "UTF-8";
    Logger logger = LoggerFactory.getLogger(this.getClass());

//    public <T extends RestResponse> T get(String url, RestRequest2 restRequest, Class<T> responseClass) {
    public <T extends RestResponse> T get(String url, RestRequest restRequest, Class<T> responseClass) {
        ...
        return this.fetchCallResponse(url, request, responseClass);
    }

    public <T extends RestResponse> T postJson(String url, RestRequest restRequest, Class<T> responseClass) {
    ...
    public <T extends RestResponse> T post(String url, RestRequest restRequest, Class<T> responseClass) throws IOException {
     ...
     */
    @Deprecated
    private String reflectUrl(RestRequest restRequest) {
